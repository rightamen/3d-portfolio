...
## 下次从这里继续（截至 2026-09-02 第二十九轮收工）

### 2026-09-02（第二十九轮）：帖子有了自己的配图，也就有了自己的分享卡片
...
**2026-09-02 收工**：当天只做了这一轮，代码已 push、已部署、已逐项验证。
工作树干净、本地与线上同码、本机没有任何服务在跑。
未完项从 8 条变成 **9 条**（新开第 12 条：没人认领的配图文件）。
「待你决策」仍然是 2 条。
...
**线上运行 `9414905`（2026-09-02 14:15 UTC 部署，已逐项验证）。**
...
```text
/opt/mrright-portfolio.backup-20260902-141551   第二十九轮之前 ← 要回滚就用这个
/opt/mrright-portfolio.backup-20260829-155129   第二十八轮之前
/opt/mrright-portfolio.backup-20260828-154600   第二十七轮第二次部署之前
```
...
还剩帖子配图和 `<noscript>`。
未完项第 9、10、11 条已关闭（第二十六至二十八轮），
**第二十九轮做完了帖子配图** —— 第二十三轮开的那份 SEO 衍生清单到此只剩
`<noscript>` 一条，而那条真要解决就是 SSR（ADR 里明写了不划算）。
所以下一轮基本是换方向了：路线图**第 7 条 C++ SDK**（体量最大，和网站关系最远），
或者未完项里那些小的（第 12 条配图清扫、6b 的服务端诊断文案翻译、
6c 的星图键盘可达）。
⚠️ 无论做哪条，**先定怎么验证**——第二十六到二十八轮的教训都在这上面。
